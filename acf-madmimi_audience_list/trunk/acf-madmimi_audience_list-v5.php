...
class acf_field_madmimi_audience_list extends acf_field {
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-madmimi_audience_list', "{$dir}js/input.js" );
		wp_enqueue_script('acf-input-madmimi_audience_list');


		// register & include CSS
		wp_register_style( 'acf-input-madmimi_audience_list', "{$dir}css/input.css" );
		wp_enqueue_style('acf-input-madmimi_audience_list');
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-madmimi_audience_list'),
		}
