...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	...
	*/
	...
	function input_admin_enqueue_scripts()
	{
		...
		wp_register_script( 'acf-input-madmimi_audience_list', $this->settings['dir'] . 'js/input.js', array('acf-input'), $this->settings['version'] );
		wp_register_style( 'acf-input-madmimi_audience_list', $this->settings['dir'] . 'css/input.css', array('acf-input'), $this->settings['version'] );


		// scripts
		wp_enqueue_script(array(
			'acf-input-madmimi_audience_list',
		));
